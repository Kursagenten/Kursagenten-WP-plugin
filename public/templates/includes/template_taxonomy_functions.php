 ...
 * @param string $setting The setting name (layout, design, list_type, buttons_display, view_type, filter_display, show_images, show_footer_links, name_display, simple_cards_grouping)
