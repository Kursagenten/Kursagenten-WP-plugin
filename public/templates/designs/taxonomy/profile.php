...
if ($view_type === 'all_coursedates') {
    ...
    // Filter-visningsmodus fra Kursdesign-innstilling (venstre / topp / filter-knapp / skjul)
    $filter_attr = get_taxonomy_kursliste_filter_attr('', $taxonomy);
    if ($filter_attr !== '') {
            ...
            <div class="taxonomy-header-profile__layout">
                ...
                <div class="taxonomy-header-profile__content">
                    ...
                    <?php if (!empty($back_link_url)): ?>
                        <a href="<?php echo esc_url($back_link_url); ?>" class="taxonomy-header-profile__back-link" title="<?php echo esc_attr(sprintf(__('Tilbake til %s', 'kursagenten'), $back_link_title)); ?>">
                            <i class="ka-icon icon-chevron-left" aria-hidden="true"></i>
                            <span><?php echo esc_html(sprintf(__('Tilbake til %s', 'kursagenten'), $back_link_title)); ?></span>
                        </a>
                    <?php endif; ?>
                </div>
            </div>
