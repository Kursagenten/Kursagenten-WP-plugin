/**
 * Build German (de_DE) translation seed files from English seeds.
 */
const fs = require('fs');
const path = require('path');

const LANG_DIR = path.join(__dirname, '..', 'lang');
const DICT_DIR = path.join(LANG_DIR, 'de-dict');
...
const translationsCount = buildFile(te, 'translations-de_DE.json');
const blockEditorCount = buildFile(be, 'block-editor-de_DE.json');

console.log(`Wrote translations-de_DE.json (${translationsCount} entries)`);
console.log(`Wrote block-editor-de_DE.json (${blockEditorCount} entries)`);
